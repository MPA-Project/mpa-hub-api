...
func Level(v uint) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
...
func LevelEQ(v uint) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldLevel), v))
	})
}
...
func LevelNEQ(v uint) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
...
func LevelIn(vs ...uint) predicate.Role {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func LevelNotIn(vs ...uint) predicate.Role {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func LevelGT(v uint) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
...
func LevelGTE(v uint) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
...
func LevelLT(v uint) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
...
func LevelLTE(v uint) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
