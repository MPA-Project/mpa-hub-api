...
func (ru *RoleUpdate) SetLevel(u uint) *RoleUpdate {
	ru.mutation.ResetLevel()
	ru.mutation.SetLevel(u)
	return ru
}

// AddLevel adds u to the "level" field.
func (ru *RoleUpdate) AddLevel(u int) *RoleUpdate {
	ru.mutation.AddLevel(u)
	return ru
}
...
// SetLevel sets the "level" field.
func (ruo *RoleUpdateOne) SetLevel(u uint) *RoleUpdateOne {
	ruo.mutation.ResetLevel()
	ruo.mutation.SetLevel(u)
	return ruo
}

// AddLevel adds u to the "level" field.
func (ruo *RoleUpdateOne) AddLevel(u int) *RoleUpdateOne {
	ruo.mutation.AddLevel(u)
	return ruo
}
