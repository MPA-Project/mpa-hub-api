...
func (uru *UserRoleUpdate) AddUserID(u int64) *UserRoleUpdate {
	uru.mutation.AddUserID(u)
	return uru
}
...
func (uru *UserRoleUpdate) AddRoleID(u int64) *UserRoleUpdate {
	uru.mutation.AddRoleID(u)
	return uru
}
...
// AddUserID adds u to the "user_id" field.
func (uruo *UserRoleUpdateOne) AddUserID(u int64) *UserRoleUpdateOne {
	uruo.mutation.AddUserID(u)
	return uruo
}
...
// AddRoleID adds u to the "role_id" field.
func (uruo *UserRoleUpdateOne) AddRoleID(u int64) *UserRoleUpdateOne {
	uruo.mutation.AddRoleID(u)
	return uruo
}
